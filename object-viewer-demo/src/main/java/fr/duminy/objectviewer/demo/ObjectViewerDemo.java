...
import fr.duminy.objectviewer.ui.ObjectViewer;

import static fr.duminy.objectviewer.ui.ObjectViewer.LOADER_PROPERTY;
import static java.lang.System.setProperty;

/**
 * @author Fabien DUMINY
 */
public class ObjectViewerDemo {
    public static void main(String[] args) throws InstantiationException {
        setProperty(LOADER_PROPERTY, DemoDataProvider.class.getName());
        ObjectViewer.main(args);
    }
}
